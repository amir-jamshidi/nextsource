...
const WithdrawItem = ({ withdraw }: WithdrawItemProps) => {
    return (
        <div className='flex justify-between bg-white dark:bg-gray-900 p-2 rounded-xl'>
            <div className="text-sm flex items-center">
                <p className='text-700-300 border-l border-l-gray-200 dark:border-gray-800 pl-2 ml-2'>{withdraw.title}</p>
                <p className='text-green-500 mt-1 font-dana-bold'>{withdraw.createdAt.toLocaleDateString('fa-IR')}</p>
            </div>

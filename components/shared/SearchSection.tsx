    ...
    return (
        <div className="h-20 bg-blue rounded-xl mt-8 flex-center">
            <div className="bg-gray-900 border border-gray-800 rounded-xl w-4/5 md:w-2/3 flex items-center">
                ...
                <input className="py-3 text-sm md:text-base text-gray-300 rounded-xl bg-transparent border-none outline-none flex-1 pl-2.5" placeholder="دنبال چی هستی ؟ برام بنویس" onChange={(e) => setSearch(e.target.value)} value={search}></input>

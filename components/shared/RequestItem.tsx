    ...
    return (
        <div className=' bg-blue-light rounded-2xl p-3'>
            <div className='flex flex-col gap-y-1.5 items-center h-[72px]'>
                ...
                <p className="text-sm  line-clamp-2 text-700-300 text-justify">{request.caption}</p>
            </div>
            <div className='mt-2 pt-2 border-t border-t-gray-200 dark:border-t-gray-800 flex justify-between items-center'>
                ...
                <div className="flex gap-1 items-center">
                    ...
                    <Link href={`/p-user/request/${request._id}`} className='dark:text-gray-300 text-blue-500 text-sm'>مشاهده</Link>
                </div>
            </div>
        </div>
    )

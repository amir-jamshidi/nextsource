    ...
    return (
        <div className=' bg-blue-light rounded-2xl p-3'>
            <div className='flex flex-col gap-y-1.5 items-center h-[46px]'>
                <p className="text-sm  line-clamp-2 text-700-300 w-full">{ticket.body}</p>
            </div>
            <div className='mt-2 pt-2 border-t-gray-200 border-t dark:border-t-gray-700/30 flex justify-between items-center'>
                ...
                <div className="flex gap-1 items-center">
                    ...
                    <Link href={`/p-user/ticket/${ticket._id}`} className='dark:text-gray-300 text-green-500 text-sm'>مشاهده</Link>
                </div>
            </div>
        </div>
    )

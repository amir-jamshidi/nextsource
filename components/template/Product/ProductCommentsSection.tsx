...
const ProductCommentsSection = async ({ comment, productID, commentRate, children, rate }: ProductCommentsSectionProps) => {
                    ...
                    {commentRate > 0 ?
                        (
                            <>
                                ...
                                <span className='text-amber-500 font-dana-bold pt-0.5'>{commentRate}</span>
                ...
                <div className=' flex text-sm items-center gap-x-1 w-14 md:w-32 justify-end'>
                    {commentRate > 0 ? (<>
                        ...
                        <div className='flex items-center'>
                            <span className='text-amber-500 font-dana-bold pt-0.5'>{Number(commentRate).toFixed(1)}</span>

            ...
            <div className="container">
                <div className='h-20 bg-blue flex rounded-xl px-3 lg:px-4'>
                    ...
                    <div className='flex-1 flex-center'>
                        <p className='text-lg text-gray-700 dark:text-gray-200 font-morabba-bold'>نکستــ</p>
                        <Link href={'/'} className='w-16 h-16'>
                            <Image priority alt='NextSource Logo App' src={'/assets/logo.svg'} width={64} height={64} />
                        </Link>
                        <p className='text-lg text-gray-700 dark:text-gray-200 font-morabba-bold'>ــسورس</p>
                    </div>

                    <div className='flex-1 flex justify-end items-center'>
                        {!isLoginUser ? (
                            <Link href={'/login'} className='flex'>
                                <span className='flex flex-center h-10 w-10 bg-blue border border-gray-200 dark:border-gray-300/10 rounded-full p-2'>
                                    <VpnKeyOutlined className='dark:text-gray-300 text-gray-600' />
                                </span>
                            </Link>) : (
                            <Link href={'/p-user/dashboard'} className='flex'>
                                <span className='flex flex-center h-10 w-10 bg-blue border border-gray-200 dark:border-gray-300/10  rounded-full p-2'>
                                    <PersonRounded className='dark:text-gray-300 text-gray-600' />
                                </span>
                            </Link>)}
                    </div>
                </div>

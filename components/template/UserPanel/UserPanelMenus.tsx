    ...
    return (
        <nav>
            <div className='container'>
                <div className='hidden bg-blue border-section flex-wrap lg:h-12 mx-2 mt-2 rounded-xl md:flex justify-center items-center gap-1 py-3 px-1.5 lg:px-0 lg:py-0'>
                ...
                <div className='md:hidden py-4 px-3 gap-1 grid grid-cols-2 grid-rows-2 bg-blue border-section  lg:h-12 mx-2 mt-2 rounded-xl'>
                    {userPanelMenus.map(menu => (
                        <Link key={menu.id} href={`/p-user${menu.href}`}>

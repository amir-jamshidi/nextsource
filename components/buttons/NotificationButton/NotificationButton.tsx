...
const NotificationButton = async () => {
    ...
    return (
        <div className="relative group">
            <span className='w-9 h-9 md:w-10 md:h-10 rounded-full flex-center bg-blue border border-gray-300/10 cursor-pointer'>
            ...
            <div className='flex absolute w-72 left-0 pt-2 delay-75 invisible group-hover:visible z-10'>
                <div className='bg-blue rounded-xl w-full p-2'>
